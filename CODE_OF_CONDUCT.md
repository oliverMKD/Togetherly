...
This Code of Conduct applies within all community spaces of this repository (issues, pull
requests, discussions), and also applies when an individual is officially representing the
...
maintainers by opening a GitHub issue tagged for maintainer attention, or, for a report you'd
prefer to keep private, via GitHub's own reporting tools on this repository. All complaints will
